...
$ kafkacat -b 3.36.125.236:9092 -L -J | jq .
```
...
* 서버1: 3.36.125.236(퍼블릭), 172.31.9.241(프라이빗)
* 서버2: 52.79.195.122(퍼블릭), 172.31.15.156(프라이빗)
* 서버3: 3.35.141.179(퍼블릭), 172.31.0.32(프라이빗)
